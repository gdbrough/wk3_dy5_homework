...
screening2.save()
screening3 = Screening.new({"film_id" => film3.id, "start_time" => "20:00", "tickets_available" => 50})
screening3.save()
screening4 = Screening.new({"film_id" => film4.id, "start_time" => "23:30", "tickets_available" => 50})
screening4.save()
